...
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, text='/', width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED,
             overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7 = Button(frame_corpo, text='*', width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED,
             overrelief=RIDGE)
...
b_11 = Button(frame_corpo, text='-', width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED,
              overrelief=RIDGE)
...
b_15 = Button(frame_corpo, text='+', width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED,
              overrelief=RIDGE)
...
b_18 = Button(frame_corpo, text='=', width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED,
              overrelief=RIDGE)
